  ...
  return (
    <main className="px-4 py-8 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <PageTitle eyebrow="Najava" title="Sljedeca utakmica i najave kola" />
        <section className="mb-6 grid gap-5 lg:grid-cols-[1fr_0.8fr]">
          <Panel className="p-6">
            <div className="mb-5 flex items-center gap-3 text-orange-300">
              <CalendarClock size={22} />
              <h2 className="text-xl font-black text-white">Sljedeci duel</h2>
            </div>
            <p className="text-sm font-bold text-orange-300">{formatDate(nextMatch.scheduledAt)}</p>
